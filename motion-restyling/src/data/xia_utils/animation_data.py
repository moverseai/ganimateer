...
class AnimationData:
    ...
    def get_joint_position(self, trim=True, return_root=False):
        pos3d = (
            forward_rotations(self.skel, self.rotations, trim=trim)[:, 1:]
            if not return_root
            else forward_rotations(self.skel, self.rotations, trim=trim)
        )
    ...
    def get_joint_velocity(self):
        ...
        return np.concatenate((velocity, last_velocity), axis=0).reshape(
            episode_length, -1
        )
